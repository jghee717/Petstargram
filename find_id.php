...
<body>
  ...
  <!-- 여기서부터 쓸꺼 쓰쎔-->
	...
	<div class="col-lg-6">
	 ...
	 <div style="text-align:center;"><h4>아이디 찾기</h4></div><br><br>
	  <div class="container">
			<form action="./pass_mail_id.php" method="post">
      ...
      <button  type="submit" class="btn btn-block btn-danger btn-lg">아이디 이메일로 전송</button><br>

										...
										<div class="card-body">
												...
												<div class="container pagination justify-content" id="search_box">
													<form action="./sitter_my.php" method="get">
														...
														<input type="hidden" name="search2" value="<?echo $res3['size']?>" required="required" />
															<input type="hidden" name="search3" value="위탁" required="required" />
												...
												<div class="container pagination justify-content" id="search_box">
													<form action="./sitter_my2.php" method="get">
														...
														<input type="hidden" name="search" value="<?echo $res3['kind']?>" required="required" />
														<input type="hidden" name="search2" value="<?echo $res3['size']?>" required="required" />
															<input type="hidden" name="search3" value="방문" required="required" />
	 ...
	 <div class="col-md-9">
			<div class="row mb-3">
					<div class="col-md-12">
						...
						<?php
							if(isset($_GET['page'])){
								$page = $_GET['page'];
										...
										$s = "select * from sitter where $catagory like '%$search_con%'";
										$conn->DBQ($s);
										$conn->DBE();
                      ...
                      <?$s = "select * from sitter where $catagory like '%$search_con%' order by idx desc limit $start_num, $list";
                        $conn->DBQ($s);
                        $conn->DBE();?>

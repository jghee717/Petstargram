...
<body>
  <?php
   ...
   $catagory = $_GET['catgo'];
	 ...
	 $catagory3 = $_GET['catgo3'];
	 $catagory4 = $_GET['catgo4'];

   $search_con = $_GET['search'];
	 $search_con2 = $_GET['search2'];
	 $search_con3 = $_GET['search3'];
	 $search_con4 = $_GET['search4'];
  ...
  <!-- 여기서부터 쓸꺼 쓰쎔--><!-- 여기서부터 쓸꺼 쓰쎔--><!-- 여기서부터 쓸꺼 쓰쎔--><!-- 여기서부터 쓸꺼 쓰쎔--><!-- 여기서부터 쓸꺼 쓰쎔--><!-- 여기서부터 쓸꺼 쓰쎔-->
	<section class="mb-5">
	  <div class="container">
		...
		<!--row mb-3-->
					<div class="row mb-3">
						  <div class="col-md-12" style="text-align:center"><br><h4><strong>위탁 펫시터</strong></h4><br>
								<div class="card">
										<div class="card-body">
			...
			<div class="row mb-3">
					<div class="col-md-12">
							...
							<form action="./sitter_leave.php" method="get">
								<input type="hidden" name="catgo" value="service">
								<div style="margin-left:10px"><span><input type="hidden" name="search3"  value="위탁" required="required"/><button class="btn btn-warning">위탁</button></span></div>
							</form>
							<form action="./sitter_visit.php" method="get">
								<input type="hidden" name="catgo" value="service">
								<div style="margin-left:10px"><input type="hidden" name="search3"  value="방문" required="required"/><button class="btn btn-warning">방문</button></div><br>
							</form>
						</div></span>
						<?php
							if(isset($_GET['page'])){
								$page = $_GET['page'];
										...
										$s = "select * from sitter where $catagory like '%$search_con%' and $catagory2 like '%$search_con2%'";
										$conn->DBQ($s);
										$conn->DBE();
                      ...
                      <?$s = "select * from sitter where $catagory like '%$search_con%' and $catagory2 like '%$search_con2%' order by idx desc limit $start_num, $list";
                        $conn->DBQ($s);
                        $conn->DBE();?>
											                  ...
											                  $img = "<img src='./img/new.png' alt='new' title='new' />";
																         ...
																         ?>
																			...
																			<div class="col-md-1">
																			 ...
																			 사이즈: <?echo $sitter['size'] ;?>	/  품종 : <?echo $sitter['kind'];?><br>

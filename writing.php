	...
	<section class="mb-5">
	    <div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="row mb-3">
	<!-- 여기서 부터 작성 --><!-- 여기서 부터 작성 --><!-- 여기서 부터 작성 --><!-- 여기서 부터 작성 --><!-- 여기서 부터 작성 --><!-- 여기서 부터 작성 -->
						<form action="./writing_ok.php" method="post" enctype="multipart/form-data">
								<div class="container">
									<div class="row">
										<div class="col-lg-12">
											<h6>위생</h6>
...
<!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 --><!-- 여기까지 -->
				  </div>
	           </div>
	        </div>
	    </div>

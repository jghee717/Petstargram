...
<body>
  ...
  <!-- 여기서부터 쓸꺼 쓰쎔-->
	...
	<div class="col-lg-6">
	 ...
	 <div style="text-align:center;"><h4>비밀번호 찾기</h4></div><br><br>
	  <div class="container">
			<form action="./pass_mail.php" method="post">
      <div class="form-group">
       <label for="name">이름</label>
        <input type="text" placeholder="이름을 입력하세요.." name="name" class="form-control" id="name" />
      </div>
  	   <div class="form-group">
  	    <label for="id">아이디</label>
  	     <input type="text" placeholder="아이디를 입력하세요.." name="id" class="form-control" id="id" />
  	   </div>
  	   <div class="form-group">
        <label for="이메일">이메일</label>
  			 <div class="input-group">
          <input type="text"  name="email" placeholder="이메일 아이디를 입력하세요.." class="form-control" id="email"> @
      ...
      <button  type="submit" class="btn btn-block btn-danger btn-lg">임시비밀번호 이메일로 전송</button><br>
      <a href="./login.php"><button class="btn btn-block btn-danger btn-lg" type="button">취소</button><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
  	 </div>
  	<div class="col-lg-3">
    </div>
	</form>
